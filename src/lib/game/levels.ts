...
export const LEVEL_SCRIPTS: LevelScript[] = [
  ...
  {
    name: "Shred School",
    blurb: "Iron hides. Crack them or bounce.",
    midShiftAfter: 4,
    waves: [
      {
        name: "Iron Recon",
      ...
      },
      {
        ...
        bonusGold: 36,
        spawns: [
          { kind: "brute", count: 5, interval: 1.05, delay: 0 },
          { kind: "scout", count: 6, interval: 0.6, delay: 1.5 },
        ],
      },
      {
        name: "Hide Wall",
        bonusGold: 40,
        spawns: [
          { kind: "brute", count: 6, interval: 0.95, delay: 0, spawnBuff: "fortify", spawnBuffDuration: 8 },
          { kind: "scout", count: 8, interval: 0.5, delay: 2 },
        ],
      },
      {
        name: "Before the Cut",
        ...
        spawns: [
          { kind: "brute", count: 4, interval: 1.0, delay: 0 },
          { kind: "hexer", count: 4, interval: 0.85, delay: 1 },
        ],
      },
      {
        name: "Cracked Tide",
        bonusGold: 48,
        spawns: [
          { kind: "hexer", count: 6, interval: 0.8, delay: 0 },
          { kind: "brute", count: 5, interval: 1.1, delay: 1.5 },
          { kind: "scout", count: 8, interval: 0.45, delay: 3 },
        ],
      },
      {
        name: "Mixed Iron",
        ...
        spawns: [
          ...
          { kind: "shield", count: 4, interval: 0.9, delay: 1 },
      ...
      },
      {
        ...
        spawns: [
          ...
          { kind: "scout", count: 10, interval: 0.4, delay: 8 },
        ],
      },
    ],
  },
  {
    name: "Blitz Road",
    blurb: "Haste runners. Frost and coverage matter.",
    midShiftAfter: 4,
    waves: [
      {
        name: "Warmup",
        bonusGold: 34,
        spawns: [
          { kind: "runner", count: 7, interval: 0.55, delay: 0 },
          { kind: "scout", count: 5, interval: 0.6, delay: 1 },
        ],
      },
      {
        name: "Frost Line",
        ...
        spawns: [
          ...
          { kind: "scout", count: 6, interval: 0.5, delay: 1.5 },
        ],
      },
      {
        name: "Haste Drill",
        bonusGold: 42,
        spawns: [
          { kind: "runner", count: 10, interval: 0.4, delay: 0, spawnBuff: "haste", spawnBuffDuration: 5 },
        ],
      },
      {
        name: "Before the Cut",
        bonusGold: 44,
        spawns: [
          { kind: "runner", count: 8, interval: 0.4, delay: 0 },
          { kind: "brute", count: 3, interval: 1.1, delay: 2 },
        ],
      },
      {
        name: "Hex Sprint",
        bonusGold: 50,
        spawns: [
          { kind: "hexer", count: 5, interval: 0.75, delay: 0 },
          { kind: "runner", count: 10, interval: 0.38, delay: 1, spawnBuff: "haste", spawnBuffDuration: 5 },
        ],
      },
      {
        name: "Mixed Dash",
        bonusGold: 54,
        spawns: [
          { kind: "runner", count: 10, interval: 0.38, delay: 0 },
          { kind: "shield", count: 4, interval: 0.85, delay: 1.5 },
      ...
      },
      {
        ...
        bonusGold: 58,
        spawns: [
          { kind: "runner", count: 16, interval: 0.32, delay: 0, spawnBuff: "haste", spawnBuffDuration: 6 },
          { kind: "scout", count: 8, interval: 0.35, delay: 1 },
        ],
      },
      {
        name: "Heavy Feet",
        ...
        spawns: [
          { kind: "brute", count: 6, interval: 0.9, delay: 0 },
          { kind: "runner", count: 10, interval: 0.4, delay: 2, spawnBuff: "haste", spawnBuffDuration: 5 },
        ],
      },
      {
        name: "All Fast",
        bonusGold: 70,
        spawns: [
          { kind: "scout", count: 10, interval: 0.35, delay: 0, spawnBuff: "haste", spawnBuffDuration: 4 },
          { kind: "runner", count: 12, interval: 0.32, delay: 1 },
          { kind: "hexer", count: 4, interval: 0.7, delay: 3 },
        ],
      },
      {
        name: "Siege Lord",
        bonusGold: 110,
        spawns: [
          { kind: "runner", count: 12, interval: 0.35, delay: 0, spawnBuff: "haste", spawnBuffDuration: 6 },
          { kind: "boss", count: 1, interval: 1, delay: 4 },
          { kind: "runner", count: 10, interval: 0.35, delay: 8 },
        ],
      },
    ],
  },
  {
    name: "Warded Night",
    blurb: "Element Ward. Super-effective hits still land.",
    midShiftAfter: 4,
    waves: [
      {
        name: "Ember Scout",
        bonusGold: 36,
        spawns: [
          { kind: "shield", count: 4, interval: 0.95, delay: 0 },
          { kind: "scout", count: 6, interval: 0.6, delay: 1 },
        ],
      },
      {
      ...
      },
      {
        ...
        spawns: [
          ...
          { kind: "runner", count: 7, interval: 0.5, delay: 2 },
        ],
      },
      {
        name: "Before the Cut",
        bonusGold: 46,
        spawns: [
          { kind: "shield", count: 6, interval: 0.8, delay: 0, spawnBuff: "ward", spawnBuffDuration: 8 },
          { kind: "hexer", count: 3, interval: 0.9, delay: 2 },
        ],
      },
      {
        ...
        bonusGold: 52,
        spawns: [
          { kind: "hexer", count: 6, interval: 0.75, delay: 0 },
          { kind: "shield", count: 6, interval: 0.8, delay: 1, spawnBuff: "ward", spawnBuffDuration: 8 },
        ],
      },
      {
        name: "Night Mix",
        ...
        spawns: [
          ...
          { kind: "hexer", count: 5, interval: 0.8, delay: 0.5 },
          { kind: "brute", count: 4, interval: 1.0, delay: 3 },
        ],
      },
      {
        name: "Ward Blitz",
        bonusGold: 60,
        spawns: [
          { kind: "runner", count: 10, interval: 0.38, delay: 0, spawnBuff: "haste", spawnBuffDuration: 5 },
          { kind: "shield", count: 6, interval: 0.75, delay: 1 },
        ],
      },
      {
        name: "Hard Ward",
        ...
        spawns: [
          ...
          { kind: "brute", count: 5, interval: 0.9, delay: 2, spawnBuff: "fortify", spawnBuffDuration: 8 },
        ],
      },
      {
        name: "Night Fronts",
        ...
        spawns: [
          ...
          { kind: "hexer", count: 6, interval: 0.7, delay: 1 },
          { kind: "runner", count: 8, interval: 0.4, delay: 2 },
      ...
      },
      {
        ...
        bonusGold: 120,
        spawns: [
          { kind: "shield", count: 7, interval: 0.7, delay: 0, spawnBuff: "ward", spawnBuffDuration: 10 },
